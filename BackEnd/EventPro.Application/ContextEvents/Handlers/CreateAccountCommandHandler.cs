...
public class CreateAccountCommandHandler : IRequestHandler<CreateAccountCommand, UserUpdateDto>
{
    ...
    public async Task<UserUpdateDto> Handle(CreateAccountCommand request, CancellationToken cancellationToken)
    {
